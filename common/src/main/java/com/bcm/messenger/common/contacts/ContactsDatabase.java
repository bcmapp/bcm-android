...
public class ContactsDatabase {
  ...
  private static final String CONTACT_MIMETYPE = "vnd.android.cursor.item/vnd.com.bcm.messenger.common.contact";
  private static final String CALL_MIMETYPE    = "vnd.android.cursor.item/vnd.com.bcm.messenger.common.call";
                                      ...
                                      @NonNull Address address, long rawContactId)
  {
    ...
    operations.add(ContentProviderOperation.newInsert(ContactsContract.Data.CONTENT_URI.buildUpon().appendQueryParameter(ContactsContract.CALLER_IS_SYNCADAPTER, "true").build())
                                           ...
                                           .withValue(ContactsContract.Data.DATA1, address.toString())
                                           .withValue(ContactsContract.Data.DATA2, context.getString(R.string.app_name))
                                           .withValue(ContactsContract.Data.DATA3, context.getString(R.string.ContactsDatabase_signal_call_s, address.toString()))
  ...
  private Optional<SystemContactInfo> getSystemContactInfo(@NonNull Address address)
  {
    ...
    Uri      uri          = Uri.withAppendedPath(ContactsContract.PhoneLookup.CONTENT_FILTER_URI, Uri.encode(address.toString()));
