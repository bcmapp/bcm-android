...
public final class CameraManager {
    ...
    public static final int MIN_FRAME_SIZE = 240;
    public static final int MAX_FRAME_SIZE = 600;

    public static final int MAX_FRAME_WIDTH = 1080;
    public static final int MAX_FRAME_HEIGHT = 1920;
    private static final int MIN_PREVIEW_PIXELS = 470 * 320; // normal screen
//    private static final int MAX_PREVIEW_PIXELS = 1280 * 720;
private static final int MAX_PREVIEW_PIXELS = MAX_FRAME_HEIGHT * MAX_FRAME_WIDTH;
    ...
    public Camera open(final TextureView textureView, final int displayOrientation) throws IOException {
        ...
        Logger.d("opening camera id {}: {}-facing, camera orientation: {}, display orientation: {}", cameraId,
...
//        final int topOffset = (height - frameSize) / 2;
        final int frameSize = Math.min(width * 5 / 6, height * 5 / 6);
        final int leftOffset = (width - frameSize) / 2;
        final int topOffset = AppUtil.INSTANCE.dp2Px(textureView.getResources(), 74);
        ...
        try {
            ...
            if (savedParameters != null) {
                ...
                try {
                    ...
                    Logger.e(x2, "problem setting camera parameters");
                }
            }
        }
        ...
        try {
            ...
            Logger.e(x, "something went wrong while starting camera preview");
            camera.release();
            throw x;
        }
    }
    ...
    public void close() {
        if (camera != null) {
            try {
                ...
                Logger.e(x, "something went wrong while stopping camera preview");
            }
