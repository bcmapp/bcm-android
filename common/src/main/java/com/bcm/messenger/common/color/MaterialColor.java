...
public enum MaterialColor {
  ...
  GROUP      (GREY.conversationColorLight, R.color.common_app_primary_color, R.color.common_primary_dark_color,
              GREY.conversationColorDark, R.color.common_dark_gray, R.color.common_color_black,
              "group_color");
