...
public class StateButton extends AppCompatTextView {
    ...
    private void setup(AttributeSet attrs) {
        ...
        //        getContext().obtainStyledAttributes(attrs, android.R.attr.background)
        ...
        //set radius
        mRadius = a.getDimensionPixelSize(R.styleable.StateButton_backgroundRadius, 0);
        mRound = a.getBoolean(R.styleable.StateButton_backgroundRound, false);
