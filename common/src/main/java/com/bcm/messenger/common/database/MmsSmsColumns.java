...
public interface MmsSmsColumns {
    ...
    public static class Types {
        ...
        protected static final long MISSED_INCOMING_CALL_TYPE = 5;
        protected static final long MISSED_OUTGOING_CALL_TYPE = 6;
        ...
        protected static final long BASE_FAIL_CANNOT_DECRYPT_TYPE = 28;

        protected static final long[] OUTGOING_MESSAGE_TYPES = {BASE_OUTBOX_TYPE, BASE_SENT_TYPE,
                BASE_SENDING_TYPE, BASE_SENT_FAILED_TYPE,
                BASE_PENDING_SECURE_SMS_FALLBACK,
                BASE_PENDING_INSECURE_SMS_FALLBACK,
                OUTGOING_CALL_TYPE, MISSED_OUTGOING_CALL_TYPE, BASE_FAIL_CANNOT_DECRYPT_TYPE};
        ...
        public static boolean isFailedCannotDecryptType(long type) {
            return (type & BASE_TYPE_MASK) == BASE_FAIL_CANNOT_DECRYPT_TYPE;
        }
        ...
        public static boolean isKeyExchangeType(long type) {
            if ((type & KEY_LOCATION_BIT) != 0)
                return false;
            return (type & KEY_EXCHANGE_BIT) != 0;
        }

        public static boolean isLocationType(long type) {
            return (type & KEY_LOCATION_BIT) != 0;
        }
        ...
        public static boolean isOutgoingMissedCall(long type) {
            return type == MISSED_OUTGOING_CALL_TYPE;
        }

        public static boolean isIncomingMissedCall(long type) {
