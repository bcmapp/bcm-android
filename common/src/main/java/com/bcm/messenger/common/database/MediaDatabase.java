...
public class MediaDatabase extends Database {
    ...
    private static final String BASE_MEDIA_QUERY = "SELECT " + AttachmentDatabase.TABLE_NAME + "." + AttachmentDatabase.ROW_ID + " AS " + AttachmentDatabase.ATTACHMENT_ID_ALIAS + ", "
        ...
        + AttachmentDatabase.TABLE_NAME + "." + AttachmentDatabase.NAME + ", "
            +AttachmentDatabase.TABLE_NAME + "." + AttachmentDatabase.DURATION + ", "
  ...
  private static final String GALLERY_MEDIA_QUERY  = String.format(Locale.US, BASE_MEDIA_QUERY, AttachmentDatabase.CONTENT_TYPE + " LIKE 'image/%' OR " + AttachmentDatabase.CONTENT_TYPE + " LIKE 'video/%'");
  private static final String DOCUMENT_MEDIA_QUERY = String.format(Locale.US, BASE_MEDIA_QUERY, AttachmentDatabase.CONTENT_TYPE + " NOT LIKE 'image/%' AND " + AttachmentDatabase.CONTENT_TYPE + " NOT LIKE 'video/%' AND " + AttachmentDatabase.CONTENT_TYPE + " NOT LIKE 'audio/%'");
