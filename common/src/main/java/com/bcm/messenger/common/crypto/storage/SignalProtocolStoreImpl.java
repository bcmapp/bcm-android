...
public class SignalProtocolStoreImpl implements SignalProtocolStore {
    ...
    public SignalProtocolStoreImpl(Context context, AccountContext accountContext) {
        this.preKeyStore = new TextSecurePreKeyStore(context, accountContext);
        this.signedPreKeyStore = new TextSecurePreKeyStore(context, accountContext);
        this.identityKeyStore = new TextSecureIdentityKeyStore(context, accountContext);
        this.sessionStore = new TextSecureSessionStore(context, accountContext);
    }
