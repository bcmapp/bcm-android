...
/**
 * Created by zjl on 2018/4/26.
 */

public class CropRoundCornerTransform extends BitmapTransformation {
    ...
    public CropRoundCornerTransform(int radius, int margin) {
        this(radius, margin, CornerType.ALL);
    }

    public CropRoundCornerTransform(int radius, int margin, CornerType cornerType) {
        this.radius = radius;
