...
public class TextSecurePreKeyStore implements PreKeyStore, SignedPreKeyStore {
    ...
    public TextSecurePreKeyStore(@NonNull Context context, @NonNull AccountContext accountContext) {
        this(context, accountContext, null);
    }

    public TextSecurePreKeyStore(@NonNull Context context, @NonNull AccountContext accountContext, @Nullable MasterSecret masterSecret) {
    ...
    private File getRecordsDirectory(String directoryName) {
        File directory = new File(accountContext.getAccountDir(), directoryName);
