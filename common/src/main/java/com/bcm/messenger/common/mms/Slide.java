...
public abstract class Slide {
    ...
    public boolean isPendingDownload() {
        return getTransferState() == AttachmentDbModel.TransferState.FAILED.getState() ||
                getTransferState() == AttachmentDbModel.TransferState.PENDING.getState();
    }
