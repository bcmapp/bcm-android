...
public class EncryptingSmsDatabase extends SmsDatabase {
    ...
    public List<SmsMessageRecord> getMessages(MasterSecret masterSecret, Cursor cursor) throws NoSuchMessageException {
        DecryptingReader reader = new DecryptingReader(masterSecret, cursor);
        List<SmsMessageRecord> list = new ArrayList();
        while (reader.getNext() != null) {
            list.add(reader.getCurrent());
        }
        reader.close();
