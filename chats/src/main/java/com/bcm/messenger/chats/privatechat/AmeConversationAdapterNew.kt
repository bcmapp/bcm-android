 ...
 *
 */
class AmeConversationAdapterNew(val context: Context, val masterSecret: MasterSecret,
                                val glideRequests: GlideRequests,
                                val locale: Locale,
                                val recipient: Recipient,
                                val delegate: IConversationDelegate) : RecyclerView.Adapter<RecyclerView.ViewHolder>(),
        StickyHeaderDecoration.StickyHeaderAdapter<AmeConversationAdapterNew.HeaderViewHolder> {
    ...
    interface IConversationDelegate {
        fun onViewClicked(adapter: AmeConversationAdapterNew, viewHolder: RecyclerView.ViewHolder)
    }
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            itemView.setOnClickListener {
                delegate.onViewClicked(this@AmeConversationAdapterNew, this)
            }
        }
    ...
    internal class LastSeenHeader(private val adapter: AmeConversationAdapterNew) : StickyHeaderDecoration(adapter, false, false) {
