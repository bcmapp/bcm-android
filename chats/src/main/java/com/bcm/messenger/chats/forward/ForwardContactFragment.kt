...
class ForwardContactFragment : Fragment(), IContactsCallback {
    ...
    override fun onStart() {
        ...
        val fragment = BcmRouter.getInstance().get(ARouterConstants.Fragment.SELECT_SINGLE)
                ...
                .putBoolean(ARouterConstants.PARAM.CONTACTS_SELECT.PARAM_CONTACT_GROUP, arguments?.getBoolean(ARouterConstants.PARAM.CONTACTS_SELECT.PARAM_CONTACT_GROUP, false)
                        ?: false)
