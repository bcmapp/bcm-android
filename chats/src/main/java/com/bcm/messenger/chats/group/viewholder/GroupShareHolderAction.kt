 ...
 */
class GroupShareHolderAction(accountContext: AccountContext) : BaseChatHolderAction<GroupShareCardView>(accountContext) {

    override fun bindData(message: AmeGroupMessageDetail, body: GroupShareCardView, glideRequests: GlideRequests, batchSelected: Set<AmeGroupMessageDetail>?) {
