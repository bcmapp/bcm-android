...
object ProxyRetryChallenge: AccountContextMap<ProxyRetryChallenge.ProxyRetryChallengeImp>({
    ProxyRetryChallengeImp(it)
}) {
    private const val ACCOUNT_CHALLENGE = "/v1/accounts/challenge/%s"

    class ProxyRetryChallengeImp(private val accountContext: AccountContext): IProxyStateChanged {
