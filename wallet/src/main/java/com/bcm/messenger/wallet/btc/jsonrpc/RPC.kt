...
object RPC {
    ...
    internal fun <T> fromJson(json: JsonElement, type: Type): T = jsonParser.fromJson(json, type)

    fun <T> fromJson(json: BufferedReader, type: Class<T>): T = jsonParser.fromJson(JsonReader(json), type)

    fun <T> fromJson(json: BufferedReader, type: Type): T = jsonParser.fromJson(JsonReader(json), type)
