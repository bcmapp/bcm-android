...
import rehanced.com.simpleetherwallet.activities.FragmentWallets;
...
public class Dialogs {
    ...
    public static void importWallets(final MainActivity c, final ArrayList<File> files) {
        ...
        builder.setMessage(c.getString(R.string.dialog_importing_wallets_text, files.size(), files.size() > 1 ? "s" : "", addresses));
