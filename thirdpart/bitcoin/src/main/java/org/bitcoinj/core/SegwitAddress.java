...
public class SegwitAddress extends Address {
     ...
     * @param witnessProgram hash of pubkey or script (for version 0)
     */
     ...
     *
     * @param params network this address is valid for
     * @param data   in segwit address format, before bit re-arranging and bech32 encoding
     * @throws AddressFormatException if any of the sanity checks fail
     */
     ...
     *
     * @param params expected network this address is valid for, or null if the network should be derived from the bech32
